"""
SQLite state: account, action_history, daily_totals, health/cooldown, post_queue.
TikTok uses separate DB so state is independent from Insta.
"""
...
# TikTok DB path: tiktok/data/tiktok_warmup.db
DEFAULT_DB_PATH = Path(__file__).resolve().parent.parent / "data" / "tiktok_warmup.db"
