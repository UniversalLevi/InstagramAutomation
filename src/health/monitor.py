"""
Account health: detect block/warning screens; set and check cooldown.
On detection: stop automation immediately, cooldown 3-7 days.
"""
...
def set_cooldown(
    ...
    """Set cooldown until a random date in [min, max] days. Returns cooldown_until_date."""
...
def get_cooldown_until(account_id: str, db_path: Optional[Path] = None) -> Optional[date]:
    """Return cooldown_until_date if in cooldown, else None."""
    from state.db import get_connection, init_schema
